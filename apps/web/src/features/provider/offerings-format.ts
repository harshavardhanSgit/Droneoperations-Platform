...
/**
 * Phrased as what the CUSTOMER gets, because that is how it reads in search results — "water
 * included" answers a question a farmer is actually asking.
 */
